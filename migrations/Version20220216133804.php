 ...
 */
final class Version20220216133804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE beneficiaire ADD satisfaisant101 VARCHAR(255) DEFAULT NULL, ADD satisfaisant102 VARCHAR(255) DEFAULT NULL, ADD satisfaisant103 VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reference CHANGE reference reference VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_general_ci`, CHANGE id_lot_unique id_lot_unique VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_general_ci`, CHANGE id_kizeo_form id_kizeo_form VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_general_ci`');
